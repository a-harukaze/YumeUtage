...
public class TButton5 : MonoBehaviour {
	...
	public void SsuteHyouzi(){
		Csute.n_teacher_ID = 4;
		Csute.hero_Kin_U = Csute.hero_Kin_U + Csute.t_Kin_U[4];
		Csute.hero_Mag_U = Csute.hero_Mag_U + Csute.t_Mag_U[4];
		Csute.hero_Bin_U = Csute.hero_Bin_U + Csute.t_Bin_U[4];
		Csute.hero_Men_U = Csute.hero_Men_U + Csute.t_Men_U[4];
		Csute.hero_Sei_U = Csute.hero_Sei_U + Csute.t_Sei_U[4];
